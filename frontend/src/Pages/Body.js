...
const Body = () => {
  ...
  return (
    <div className="flex flex-col w-screen mt-14 sm:mt-0 gap-8">
      <div className="bg-gray-200 py-20 flex flex-col w-full">
            ...
            <div className="gap-3 text-center items-center lg:text-left flex flex-col z-10 sm:z-0">
              <div className="space-y-2 w-1/2">
                ...
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                  Your car deserves the best. Experience the ultimate shine with
                  our professional carwash and detailing services.
                </p>
                <Link
                  className="flex h-10 w-36 items-center justify-center rounded-md border border-gray-200 bg-white px-8 text-md font-medium shadow-lg hover:bg-black hover:text-white mt-6 ml-0"
                  to="/service"
                  onClick={() => {
                    navigate("/service");
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                We offer more than just a carwash. Our attention to detail and
                dedication to quality ensure that your vehicle shines inside and
                out.
              </p>
            </div>
          </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="grid items-center gap-6 lg:grid-cols-[1fr_800px] lg:gap-12">
            <div className="space-y-2">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                Select the perfect package for your car. Whether you want a
                quick wash or a complete makeover, we've got you covered.
              </p>
            </div>
              ...
              <div className="border rounded-lg overflow-hidden border-gray-200 border-gray-200 dark:border-gray-800 dark:border-gray-800">
                <div className="grid items-center gap-4 p-4 md:grid-cols-2 lg:gap-6 lg:p-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Our essential package includes a thorough exterior wash to
                ...
                <div className="grid items-center gap-4 p-4 md:grid-cols-2 lg:gap-6 lg:p-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Upgrade to our premium package for a complete interior
                      cleaning and tire shine.
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
                ...
                <div className="grid items-center gap-4 p-4 md:grid-cols-2 lg:gap-6 lg:p-6">
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold">Deluxe Detailing</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Experience the ultimate treatment with our deluxe
                      detailing package, including a full interior deep clean
                      and hand wax for a showroom shine.
                    </p>
                  </div>
                  <div className="flex items-center justify-between">
