...
const Contact = () => {
  ...
  return (
    <div className="w-screen container bg-gray-200 items-center backdrop:blur-md flex justify-center flex-col">
      <div className="w-full flex md:flex-row flex-col-reverse items-center md:h-screen">
        <div className="flex flex-start md:justify-center w-full bg-[#0C2D57] h-[300px]">
          ...
          <div className="">
            ...
            <div className="">
              ...
              <address  className="float-start ">Kanti Kunj, Patna, Bihar, 800020, India</address>
            </div>
            <div className="">
              <div className="flex gap-4">
              ...
              <email className="float-left">satyam8804378323@gmail.com</email>
            </div>
          </div>
        </div>
        <div className="flex flex-col md:absolute right-40 bottom-0 w-[400px] bg-white p-8  gap-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
            ...
            <button
              type="submit"
              className="w-full py-2 px-4 bg-[#0C2D57] hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-center text-white"
            >
              Submit
            </button>
          </form>
